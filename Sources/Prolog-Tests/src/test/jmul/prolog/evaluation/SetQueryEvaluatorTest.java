 ...
 */
@UnitTest
public class SetQueryEvaluatorTest {
    ...
    public void testSetQuery() {
        ...
        SetQuery question = new SetQuery("is_article");

        Set<String> expectedAnswer = newSet("the", "a", "an");
     ...
     */
    @Test
    public void testSetQueryVariant2() {

        SetQuery question = new SetQuery("is_known");

        Set<String> expectedAnswer = newSet("the", "a", "an", "no", "some");
