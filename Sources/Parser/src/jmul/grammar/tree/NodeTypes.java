...
/**
 * Thie enumration defines several node types (see
...
public enum NodeTypes implements NodeType {
    ...
    /**
     * NP for noun phrase. The first (leftmost) NP, a single noun serves as the subject of the sentence. The second
    ...
    /**
     * D for determiner, e.g. an article.
     */
    D,
