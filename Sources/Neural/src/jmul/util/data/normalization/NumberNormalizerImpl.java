...
/**
 * An implementation for a normalizer for numbers.
 *
 * @author Kristian Kutin
 */
public class NumberNormalizerImpl implements Normalizer<Number> {
     ...
     *        an interval
     */
    public NumberNormalizerImpl(Interval intervalFrom, Interval intervalTo) {
    ...
    /**
     * Normalizes the specified number.
     *
     * @param n
     *        a number
     *
     ...
     */
    @Override
    public Number normalize(Number n) {
