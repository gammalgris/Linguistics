...
/**
 * An implementation of an input layer.
 *
 * @author Kristian Kutin
 */
class InputLayerImpl implements Layer {
     ...
     *        a number base
     */
    public InputLayerImpl(int base) {
    ...
    public void updateBias(Number newBias) {
        ...
        throw new UnsupportedOperationException("Cannot change the bias of the input layer!");
    }
