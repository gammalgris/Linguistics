...
/**
 * This interface describes an entity which evaluates a question which returns a set.
 *
 * @author Kristian Kutin
 */
public interface SetQueryEvaluator {
     ...
     */
    Set<String> evaluate(SetQuery question);
